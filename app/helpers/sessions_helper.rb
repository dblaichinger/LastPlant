module SessionsHelper
  ...
  ## Methods for Facebook - Login
	def establish_graph
		...
		$token = Koala::Facebook::OAuth.new("184822371541001", '7172b72fea0b4453481403d50604743b', "http://lastplantbeta.heroku.com/").get_access_token(@code)
		$graph = Koala::Facebook::GraphAPI.new($token)
	end
	
	def establish_oauth
	  $oauth = Koala::Facebook::OAuth.new("184822371541001", '7172b72fea0b4453481403d50604743b', "http://lastplantbeta.heroku.com/")
	end
